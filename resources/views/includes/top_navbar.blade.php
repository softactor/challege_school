<div class="nav-header">
    <a href="#" class="brand-logo">
        <img src="{{ asset('public/theme/images/logo_dashboard.png') }}" />
    </a>
                        ...
                        <ul class="contacts">
                            ...
                            <li class="active dz-chat-user">
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont">
                                        <img src="{{ asset('public/theme/images/avatar/1.jpg') }}" class="rounded-circle user_img" alt="" />
                            ...
                            <li class="dz-chat-user">
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont">
                                        <img src="{{ asset('public/theme/images/avatar/2.jpg') }}" class="rounded-circle user_img" alt="" />
                            ...
                            <li class="dz-chat-user">
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont">
                                        <img src="{{ asset('public/theme/images/avatar/3.jpg') }}" class="rounded-circle user_img" alt="" />
                                        <span class="online_icon"></span>
                                    </div>
                                    <div class="user_info">
                            ...
                            <li class="dz-chat-user">
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont">
                                        <img src="{{ asset('public/theme/images/avatar/4.jpg') }}" class="rounded-circle user_img" alt="" />
                                        <span class="online_icon offline"></span>
                                    </div>
                                    <div class="user_info">
                            ...
                            <li class="dz-chat-user">
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont">
                                        <img src="{{ asset('public/theme/images/avatar/5.jpg') }}" class="rounded-circle user_img" alt="" />
                                        <span class="online_icon offline"></span>
                                    </div>
                                    <div class="user_info">
                    ...
                    <div class="card-body msg_card_body dz-scroll" id="DZ_W_Contacts_Body3">
                        <div class="d-flex justify-content-start mb-4">
                            <div class="img_cont_msg">
                                <img src="{{ asset('public/theme/images/avatar/1.jpg') }}" class="rounded-circle user_img_msg" alt="" />
                            </div>
                        ...
                        <div class="d-flex justify-content-end mb-4">
                            ...
                            <div class="img_cont_msg">
                                <img src="{{ asset('public/theme/images/avatar/2.jpg') }}" class="rounded-circle user_img_msg" alt="" />
                            </div>
                        </div>
                        <div class="d-flex justify-content-start mb-4">
                            <div class="img_cont_msg">
                ...
                <ul class="navbar-nav header-right main-notification">
                                    ...
                                    <li>
                                        <div class="timeline-panel">
                                            <div class="media mr-2">
                                                <img alt="image" width="50" src="{{ asset('public/theme/images/avatar/1.jpg') }}">
                                            </div>
                    ...
                    <li class="nav-item dropdown header-profile">
                        <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                            <img src="{{ asset('public/theme/images/profile/pic1.jpg') }}" width="20" alt="" />
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a href="{{ url('logout') }}" class="dropdown-item ai-icon" href="{{ route('logout') }}"
